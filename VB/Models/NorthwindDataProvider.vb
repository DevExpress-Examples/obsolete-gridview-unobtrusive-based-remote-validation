...
Public Class NorthwindDataProvider
	...
	Public Shared Function CheckIfExists(ByVal ProductName As String, ByVal OriginalProductName As String) As Boolean
		If ProductName = OriginalProductName Then
			Return False
		End If

		Dim products As List(Of Product) = DirectCast(GetProducts(), List(Of Product))

		For Each product In products
			If product.ProductName = ProductName Then
				Return True
			End If
		Next product
